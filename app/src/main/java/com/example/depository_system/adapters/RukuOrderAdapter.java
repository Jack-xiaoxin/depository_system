...
//                itemHolder.imageView.setImageURI(Uri.parse("D:\\projects\\depository_system\\app\\src\\main\\res\\drawable\\alarm_on.png"));
                itemHolder.factory_name.setText(mList.get(position).factoryName);
                itemHolder.orderId.setText(mList.get(position).inboundId);
                ...
                if(originaldate.length() != 10) {
                    ...
                    itemHolder.time.setText(originaldate);
                }
